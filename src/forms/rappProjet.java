 ...
 */
public class rappProjet extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Rapport de projet");
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        try {
            MessageFormat header = new MessageFormat("Rapport des projets ");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
                db.go.fillToJTableWithTableName("project", tblPro);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rappProjet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rappProjet().setVisible(true);
            }
        });
    }
