 ...
 */
public class rappDept extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Rapport de département");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        db.go.fillToJTableWithTableName("dept", TblDept);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        try {
            MessageFormat header = new MessageFormat("Rapport de département ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rappDept.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
